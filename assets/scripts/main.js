document.addEventListener('DOMContentLoaded', () => {
  ...
  const assistantKnowledge = [
    ...
    },
    {
      ...
      answer: 'Para soporte o consultas puedes usar el contacto de la landing: safedrive@gmail.com o el numero +51 987 654 321. En una version real tambien podria agregarse un canal de soporte dentro del dashboard.'
    },
    {
  ...
  const footerInfo = {
    about: {
      ...
      html: `
        <p>FatigueGuard by SafeDrive es una propuesta enfocada en reducir accidentes causados por fatiga al volante. La landing presenta la solucion para empresas de transporte que necesitan monitorear conductores, vehiculos, alertas y reportes desde un panel privado.</p>
        <ul class="info-list">
          <li>Objetivo: prevenir riesgos antes de que ocurra un accidente.</li>
          <li>Enfoque: seguridad vial, control de flota y seguimiento empresarial.</li>
          <li>Uso: la app detecta fatiga y el dashboard permite tomar decisiones.</li>
        </ul>
      `
    },
    jobs: {
      ...
      html: `
        <p>Esta seccion puede usarse para invitar a personas interesadas en tecnologia, seguridad vial, transporte, inteligencia artificial y soporte empresarial.</p>
        <ul class="info-list">
          <li>Enviar CV a safedrive@gmail.com con el asunto "Postulacion FatigueGuard".</li>
          <li>Areas sugeridas: desarrollo web, IA, atencion al cliente, ventas B2B y operaciones.</li>
          <li>Indicar disponibilidad, experiencia y ciudad de residencia.</li>
        </ul>
      `
    },
    help: {
      ...
      html: `
        <p>El centro de ayuda orienta a empresas que quieren entender como usar el sistema, crear una cuenta, iniciar sesion o revisar el dashboard.</p>
        <ul class="info-list">
          <li>Registro: completa los datos de la empresa y crea una cuenta de administrador.</li>
          <li>Inicio de sesion: usa el correo y contrasena registrados.</li>
          <li>Dashboard: revisa conductores, vehiculos, alertas, estadisticas y reportes.</li>
          <li>Soporte: escribe a safedrive@gmail.com o llama al +51 987 654 321.</li>
        </ul>
      `
    },
    terms: {
      ...
      html: `
        <p>FatigueGuard se presenta como un prototipo academico y demostrativo. La informacion mostrada en la landing y dashboard sirve para explicar el funcionamiento de una plataforma de monitoreo de fatiga.</p>
        <ul class="info-list">
          <li>El usuario debe registrar datos reales solo si el sistema pasa a produccion.</li>
          <li>Las alertas son de apoyo y no reemplazan protocolos internos de seguridad.</li>
          <li>La empresa usuaria es responsable de actuar frente a conductores en riesgo.</li>
          <li>Los reportes del prototipo son simulados para fines de demostracion.</li>
        </ul>
      `
    },
    privacy: {
      ...
      html: `
        <p>La privacidad es importante porque el sistema trabaja con informacion empresarial y posibles datos de fatiga del conductor. En una version real, estos datos deben protegerse con reglas claras.</p>
        <ul class="info-list">
          <li>Los datos de registro se usan para crear la cuenta empresarial.</li>
          <li>La informacion de conductores debe manejarse con autorizacion y seguridad.</li>
          <li>Los eventos de fatiga deben consultarse solo por personal autorizado.</li>
          <li>Este prototipo guarda informacion en localStorage del navegador.</li>
        </ul>
      `
    },
    contact: {
      title: 'Contacto',
      html: `
        <p>Para consultas sobre FatigueGuard, soporte, alianzas o informacion comercial puedes usar estos datos de contacto de ejemplo.</p>
        <ul class="info-list">
          <li>Correo: safedrive@gmail.com</li>
          <li>Telefono: +51 987 654 321</li>
          <li>Ubicacion: Lima, Peru</li>
          <li>Horario sugerido: lunes a viernes de 9:00 a.m. a 6:00 p.m.</li>
        </ul>
      `
    }
  };
  ...
  function openInfoModal(key) {
    const content = footerInfo[key] || footerInfo.help;
    if (infoTitle) infoTitle.textContent = content.title;
    if (infoBody) infoBody.innerHTML = content.html;
    closeModals();
    openModal(infoModal);
  }
  ...
  document.addEventListener('click', event => {
    const infoLink = event.target.closest('[data-info-key]');
    if (infoLink) {
      event.preventDefault();
      openInfoModal(infoLink.dataset.infoKey);
      return;
    }
